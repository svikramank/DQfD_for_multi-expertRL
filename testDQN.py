...
#    dqfd_mean_scores_with_AC_expert_large_decay = []
    ...
    dqfd_mean_scores_with_DDQN_expert_large_decay = [x/Config.iteration for x in dqfd_sum_scores]
    with open('/Users/vikramanksingh/Desktop/DQfD/dqfd_mean_scores_with_DDQN_expert_large_decay.p', 'wb') as f:
        pickle.dump(dqfd_mean_scores_with_DDQN_expert_large_decay, f, protocol=2)
    ...
    #map_scores(dqfd_scores=dqfd_mean_scores_large_decay, ddqn_scores=ddqn_mean_scores,
    #xlabel='Red: ddqn_with_demo_from_all_experts_large_decay      Blue: ddqn_without_demo', ylabel='Scores')
    # env.close()
