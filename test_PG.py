...
#    dqfd_mean_scores_with_DDQN_expert_large_decay = []
    ...
    dqfd_mean_scores_with_PG = [x/Config.iteration for x in dqfd_sum_scores]
    with open('/Users/vikramanksingh/Desktop/DQfD/dqfd_mean_scores_with_PG.p', 'wb') as f:
        pickle.dump(dqfd_mean_scores_with_PG, f, protocol=2)
